Ethical Hacker Essential Kit 
 ...
 2.  Enum4Linux (It's a tool for enumerating information from Windows and Samba systems…)
 ...
 5.  Wireshark (Network analyzer with six hundred authors. With this software, can quickly capture and interpret network packets…)
 ...
 20. Hydra and xHydra  (IT's a parallelized login cracker which supports numerous protocols to attack. It is extremely fast and flexible, and new modules are easy to add…)
 ...
 26. Top Parrot Security Linux Tools

27. Enough at moment…. We will be back with Bitcoins, Cryptography…
...
Additional note: Don't forget user VM and/or a Raspberry Pi or similar :)
